...
export default function MentionsLegales({
  ...
  return (
    <>
      <Helmet>
        <title>MNG DEV – Mentions légales</title>
        <meta
          name="description"
          content="Mentions légales du site MNG DEV. Informations sur l'éditeur, l'hébergeur et la protection des données."
        />
        <link rel="canonical" href="https://mngdev.pro/mentions-legales" />
      </Helmet>
      <main className="max-w-4xl mx-auto px-6 py-12 prose prose-invert mt-50">
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            exclusive de {companyName} ou de ses partenaires et est protégé par
            le droit de la propriété intellectuelle. Toute reproduction totale
            ou partielle, modification, diffusion ou réutilisation sans
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            ne contrôle pas ces sites et décline toute responsabilité quant à
        ...
        <section className="mb-6">
          ...
          <p>
            Lors de l'utilisation des formulaires ou services du site, des
            données personnelles peuvent être collectées (nom, email, téléphone,
            message, etc.). Ces données sont traitées par {companyName} pour
            répondre à vos demandes.
          </p>
          <p>
            Conformément au RGPD, vous disposez d'un droit d'accès, de
            rectification, d'effacement, de limitation du traitement,
            d'opposition et de portabilité des données. Pour exercer ces droits
            :{" "}
            <a href={`mailto:${email}`} className="text-neon-cyan">
              {email}
            </a>
        ...
        <section className="mb-6">
          ...
          <p>
            Le site peut utiliser des cookies et autres traceurs pour améliorer
            la navigation, analyser la fréquentation et proposer des
            fonctionnalités. Vous pouvez gérer vos préférences via votre
            navigateur.
          </p>
        </section>
